...
function App() {
  ...
  setShowGoogleAccountModal, setShowMemberKeyModal, showAccountMenu, streak, toBn
    ...
    className: "animate-spin",
    size: 16
  }) : meetingSavedTick ? "সেভ ও সিংক হয়েছে!" : "মাসিক সভা ও সিদ্ধান্ত সেভ করুন")))), React.createElement(ArchiveModal, {show: showArchiveModal, onClose: () => setShowArchiveModal(false), archiveMonth0, setArchiveMonth0, archiveYear, setArchiveYear, BN_MONTHS, toBn, handleGoToArchive}), showFamilyCodeChoiceModal && /*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center px-5 z-50"
  }, /*#__PURE__*/React.createElement("div", {
    className: "bg-white rounded-3xl p-5 w-full max-w-sm shadow-xl border border-slate-100"
  }, /*#__PURE__*/React.createElement("h3", {
  ...
  }, "প্রত্যাখ্যান"))))))), googleAccountModalNode, approvedGoogleWelcomeNode,
...
function GoogleAccountModal({
  ...
  onFirstAdminClaimed,
  memberName,
  // §Approved-member Google welcome(২৩ আগস্ট ২০২৬): শুধু body-text ও বাটন-সেট
  // বদলানোর জন্য optional prop — handleLink()/linkGoogleAccount() flow
  // অপরিবর্তিত(same existing reuse), কোনো নতুন auth logic নেই। prop না দিলে
  // আগের আচরণ হুবহু অক্ষত।
  welcomeMode,
  onLater
}) {
