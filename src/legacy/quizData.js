...
// §১.১ — ব্লগ-ক্যাটাগরির(3_4 §১.১, ১৬ সেপ্টেম্বর ২০২৬ সংস্করণ) সাথে হুবহু
// মেলানো, ইচ্ছাকৃতভাবে হার্ডকোডেড(3_5 §১.১ অনুযায়ী — স্বতন্ত্র কালেকশন, blogData.js
// থেকে import করা হয়নি, কোনো cross-file dependency না)।
